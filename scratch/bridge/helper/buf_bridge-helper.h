 ...
 */
#ifndef BUF_BRIDGE_HELPER_H
#define BUF_BRIDGE_HELPER_H
 ...
 */
class BufBridgeHelper
{
public:
  /*
   * Construct a BufBridgeHelper
   */
  BufBridgeHelper ();
  /**
   * Set an attribute on each ns3::BridgeNetDevice created by
   * BufBridgeHelper::Install
   *
   ...
   * configured by BufBridgeHelper::SetDeviceAttribute, adds the device
